...
const ContactPage = () => {
  return (
    <Box sx={{ padding: "100px" }}>
      ...
      <ul>
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device, named Srot
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Scodus Innovations Private Limited,
            Kathmandu, Nepal.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Srot, accessible from{" "}
            <a
              href="http://srotcloud.com"
      ...
      <ul>
        <li>By email: support@srotcloud.com</li>
      </ul>
    </Box>
  );
};
